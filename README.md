...
| Folder                      | Description   
| --------------------------- | -------------
| LongPollingServer           | A project with both event (`EFTClientIP`) and async/await based (`EFTClientIPAsync`) wrapper objects for the EFT-Client TCP/IP interface.
| LongPollingTestClient       | A basic sample app using the `EFTClientIPAsync` component
| SharedLibrary               | A basic sample app using the `EFTClientIP` component
